	...
	return (
		<div className="app">
			<header className="app__header">
				<h1>
					<img src={Logo} className="logo" alt="React Messenger" /> React Messenger
				</h1>
			...
			<form className="app__form" onSubmit={sendMessage}>
				<ThemeProvider theme={theme}>
					<FormControl className="app__formControl">
						...
						<IconButton className="app__button" disabled={!input} color="primary" variant="contained" type="submit" onClick={sendMessage}>
							<SendIcon />
						</IconButton>
					</FormControl>
				</ThemeProvider>
